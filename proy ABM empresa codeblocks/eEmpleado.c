    ...
    if( listaEmpleados != NULL && tamListaEmpleados > 0 && listaSectores != NULL && tamListaSectores > 0)
    {
        do
        {
                    utn_pMenuOpciones_(&opcion
                                      ,"\n\n   MENU CARGAS  \n"
                                      " 1.CARGAR LISTA EMPLEADOS VACIA \n"
                                      " 2.CARGAR LISTA DE SECTORES VACIA \n"
                                      " 3.CARGAR LISTA DE COMIDAS VACIA \n"
                                      " 4.CARGAR LISTA DE ALMUERZOS VACIA\n"
                                      " 5.SALIR \n"
                                      "\n INGRESE UNA OPCION: "
            ...
            case 1:
                ...
                if(!utn_pRespuestaBooleanaSiUno_NoCero("\n\n ATENCION: SI USTED CARGA UNA PLANTILLA VACIA DE EMPLEADOS,"
                                                       "SE BORRARAN LOS EMPLEADOS INGRESADOS POR DEFECTO \n"
                                                       "\n DESEA CREAR UNA LISTA VACIA DE EMPLEADOS? S/N  "
                ...
                else
                {
                    ...
                    utn_mostrarMensaje("\n LISTA VACIA DE EMPLEADOS CARGADA CON EXITO \n");

                    EMPLEADO_pInicializaEstructuras_DeTam_(listaEmpleados,tamListaEmpleados);
            ...
            default:
                ...
                if(utn_pMenuContinuarSiEsLetraS_ONoSiEsN_DeTam_(&salir,"\n DESEA SALIR DEL MENU CARGAS? S/N: ",
                        "HA OCURRIDO UN ERROR\n",2)
                        && salir == 'S' || salir == 's')
